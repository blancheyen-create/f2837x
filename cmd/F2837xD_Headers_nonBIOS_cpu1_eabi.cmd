...
/*** PIE Vect Table and Boot ROM Variables Structures ***/
  UNION run = PIE_VECT
   ...
   //調整後>>
   AdcaResultRegsFile  : > ADCA_RESULT, type=NOINIT
   AdcbResultRegsFile  : > ADCB_RESULT, type=NOINIT
   AdccResultRegsFile  : > ADCC_RESULT, type=NOINIT
   AdcdResultRegsFile  : > ADCD_RESULT, type=NOINIT
